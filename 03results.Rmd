...
```{r graficoDDInc, echo=FALSE, warning=FALSE, fig.cap = 'Distribuição do incremento diamétrico anual para cada grupo ecológico por centro de classe.'}
...
incMedGrupoEco <- stan_glm(
  incAnual ~ cc|GrupoEco,
  data = incEco,
  family = gaussian(link="identity"))

bayesplot::color_scheme_set("viridis")
plot(incMedGrupoEco, plotfun = "areas", prob = 0.9, regex_pars = c("(Intercept)", "Grupo"))
```
