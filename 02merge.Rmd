...
```{r pacotes1, echo=FALSE, warning=FALSE}
require(dplyr)
require(tidyr)
require(splus2R)
require(plotly)
...
```{r folders, echo=FALSE, warning=FALSE}
PATH = 'psb/'
COMPL = 'auxiliar/'
```

```{r processInv, echo=FALSE, warning=FALSE}
...
```{r mergeInv, echo=FALSE, warning=FALSE}
...
```{r mutate, echo=FALSE, warning=FALSE}
...
```{r grupoEcologico, echo=FALSE, warning=FALSE}
